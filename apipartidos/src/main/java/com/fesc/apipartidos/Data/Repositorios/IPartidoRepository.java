...
public interface IPartidoRepository extends PagingAndSortingRepository<PartidoEntity, Long>{ /*PagingSorting interfaz que proporciona métodos para realizar
                                                                                            operaciones de paginación y ordenación en un repositorio de datos */
