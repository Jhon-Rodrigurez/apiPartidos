...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        ...
        return http //la seguridad que nos proporciona en la aplicacion no permite que otras url entren sin autenticarse
            .cors()
            .and()
            .csrf().disable()
            .authorizeHttpRequests()
            .requestMatchers(HttpMethod.POST, "/usuario").permitAll() //le estamos permitiendo el acceso a este endpoint a la aplicacion
            .requestMatchers(HttpMethod.GET, "/partido").permitAll() //le estamos permitiendo el acceso a este endpoint a la aplicacion
            .requestMatchers(HttpMethod.GET, "/partido/{id}").permitAll() //le estamos permitiendo el acceso a este endpoint a la aplicacion
