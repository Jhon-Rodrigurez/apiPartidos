...
public class UsuarioController {
    ...
    @GetMapping(produces = {MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_VALUE}) /*método anotado puede producir tanto respuestas XML como respuestas JSON */
